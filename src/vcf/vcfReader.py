...
class VcfMutationsReader(object):
    ...
    def get_seq_sufix(self, pointer_index, to_nuc, chromosome_label):
    ...
    def get_seq_by_chr_pos(self, chromosome_label: str, pos: int, from_nuc: int = False, to_nuc: int = False,):
